...
export default function ProfilePage({
  ...
  return (
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <FeedbackWidget startupId={id} sectionId={activeSection} sectionLabel={SECTION_LABELS[activeSection] ?? ""} />
    </div>
  )
}
...
function FeedbackWidget({ startupId, sectionId, sectionLabel }: { startupId: string; sectionId: string; sectionLabel: string }) {
