...
export async function researchStartup(req: ResearchRequest): Promise<StartupProfile> {
  ...
  const PASS_BATCHES: PassName[][] = [
    ["overview"],
    ["founders", "glassdoor"],
    ["funding", "competitive", "products", "regulatory", "youtube"],
    ["signals"],
    ["linkedin"],
    ["insights"],
  ]
  ...
  return {
    ...
    competitor_1_name:              merged.competitor_1_name,
    competitor_1_funding_usd_m:     merged.competitor_1_funding_usd_m,
    competitor_1_stage:             merged.competitor_1_stage,
    competitor_2_name:              merged.competitor_2_name,
    competitor_2_funding_usd_m:     merged.competitor_2_funding_usd_m,
    competitor_2_stage:             merged.competitor_2_stage,
    competitor_3_name:              merged.competitor_3_name,
    competitor_3_funding_usd_m:     merged.competitor_3_funding_usd_m,
    competitor_3_stage:             merged.competitor_3_stage,
    market_leader_name:             merged.market_leader_name,
    geo_analog_company:             merged.geo_analog_company,
    geo_analog_country:             merged.geo_analog_country,
    competitive_density:            merged.competitive_density,
